...
//Extra thanks to Flenix for his renderer tutorial.

public class CampfireRenderer extends TileEntitySpecialRenderer {

	private final CampfireModel model;
...
//Use in 1.6.2  this
        ResourceLocation textures = new ResourceLocation(Main.MODID, "textures/blocks/campfire.png"); 
